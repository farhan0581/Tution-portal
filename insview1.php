...
require_once('connect.php');
  ...
  if (isset($_SESSION['user_name'])) { 
    ...
    $query = "SELECT username, name, email,class,school, location, city,state,phone,t1,t2 FROM student WHERE stdid = '" . $id. "'";
...
<b> 
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Class:</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="border:0" name="class"
  value="<?php if (!empty($row['class'])) echo $row['class'] ; ?>">
...
<br><br>
<p>
 <h1><font color="black"><b>School:</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="border:0" name="subject"  value="<?php if (!empty($row['school'])) echo $row['school'] ; ?>"size="30"></h1>
