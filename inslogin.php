...
<form method="post" action="<?php echo $_SERVER["PHP_SELF"]?>">
      ...
      <h1>User names can be any combination of letters, numbers, underscores and hyphens, up to 15 characters in length.Cannot be changed later</h1>
      </font>
      <br><br>
      <p><br>
...
<p>
 <h1><font color="black">Institute Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="name" size="30" value="<?php if (!empty($_POST['name'])) echo $_POST['name'] ; ?>"></h1>
...
<font color="black">
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Fee Structure(Per subject): &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="fees">
...
<p>
 ...
 <h1><font color="black">Contact No.: &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="number" size="30" value="<?php if (!empty($_POST['number'])) echo $_POST['number'] ; ?>"></h1>
  ...
  <p>
 <h1><font color="black">Timing(24 Hr):  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><font color="black">From: <input type="text" name="t1" size="10" value="<?php if (!empty($_POST['t1'])) echo $_POST['t1'] ; ?>">  &nbsp;&nbsp;To:  <input type="text" name="t2" size="10" value="<?php if (!empty($_POST['t2'])) echo $_POST['t2'] ; ?>"></h1>
      ...
      require_once('footer.php'); 
        ...
        {   
           ...
           // $ql=$_POST['qual'];
            ...
            if(!empty($n1)&&!empty($e1)&&!empty($p1)&&!empty($p2)&&!empty($user)&&!empty($sub)&&!empty($fe)&&!empty($loct)&&!empty($ct)&&!empty($nm)&&!empty($tm1)&&!empty($tm2)&&!empty($st))
            {
              if($p1===$p2)
              {
                if(strlen($p1)>=6)
                {
                      ...
                      else
                      {
                          ...
                          $query1="insert into log(username,password,type) values ('$user','$p1','institute')";
                          $query2="insert into institute(username,password,name,email,subjects,fee,location,city,state,phone,t1,t2) values('$user','$p1','$n1','$e1','$sub','$fe','$loct','$ct','$st',$nm,$tm1,$tm2)";
            ...
            {
                         echo "<script type='text/javascript'>alert('minimum length is 6!!!');</script>";
