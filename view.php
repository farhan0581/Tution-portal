...
<p>
 <h1><font color="black">Address: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><font color="black">Location: <input type="text" name="loc" size="20" value="<?php if (!empty($row['location'])) echo $row['location'] ; ?>">&nbsp;&nbsp;&nbsp;&nbsp;City: <input type="text" name="city" size="20" value="<?php if (!empty($row['city'])) echo $row['city'] ; ?>">&nbsp;&nbsp;&nbsp;&nbsp;State: <input type="text" name="state" size="20" 
