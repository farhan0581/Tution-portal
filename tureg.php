...
<form method="post" action="<?php echo $_SERVER["PHP_SELF"]?>">
      ...
      <h1>Member names can be any combination of letters, numbers, underscores and hyphens, up to 15 characters in length. Cannot be changed later.</h1>
      </font>
      <br><br>
      <p><br>
...
<font color="black">
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Fee Structure(per sub): &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="fees">
            ...
            if(!empty($n1)&&!empty($e1)&&!empty($p1)&&!empty($p2)&&!empty($user)&&!empty($sub)&&!empty($ql)&&!empty($fe)&&!empty($loct)&&!empty($ct)&&!empty($nm)&&!empty($tm1)&&!empty($tm2)&&!empty($st))
            {
              if($p1==$p2)
              {
                if(strlen($p1)>=6)
                {
                     ...
                     if($status2)
                     {
                         echo "<script type='text/javascript'>alert('you have been registered!');location.href='tureg.php'</script>"; 
                     }
                     else
