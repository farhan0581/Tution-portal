...
require_once('connect.php');
          $rs=mysqli_query($d1,"SELECT COUNT(sname) from icomment");
...
@session_start();
   ...
   if(!isset($_SESSION['user_name']))
   {
    ...
    require_once('connect.php');
                                ...
                                $rs_result = mysqli_query ($d1,"SELECT * FROM icomment  ORDER by sname LIMIT $start_from, 6");
                               ...
                               // $_SESSION['id1']=$row['tuid'];
                                ...
                                while ($row = mysqli_fetch_array($rs_result)) {
                                    ?>
                                        <form  method = "POST" action="aicom.php">
                                        <div class="col-md-4">
                                              <div class="jumbotron">
                                              <font color="black">
                                ...
                                ?>
                                        ...
                                        <?php
                                $result = mysqli_query($d1,"SELECT COUNT(sname) FROM icomment ");
                                ...
                                for ($i=1; $i<=$f; $i++) {
                                            //echo '<button';
                                            echo "<a href='aicom.php?page=".$i."'>   " . $i. "</a>";
                                            //echo '</footer>';
                                }
...
if(isset($_POST['delete']))
{
  $id=$_POST['vid'];
  require_once('connect.php');
  $q="DELETE from icomment where cid='".$id."'";
  $d=mysqli_query($d1,$q);
  if($d)
  {
                                     echo"<script type='text/javascript'>alert('!!comment deleted!!'); location.href='aicom.php'</script>";

  }
  else
                                     echo"<script type='text/javascript'>alert('!!Not deleted!!'); location.href='aicom.php'</script>";
