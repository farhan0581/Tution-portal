...
<section id="content">
<form method="post" action="<?php echo $_SERVER["PHP_SELF"]?>" id="ck_ing">
      <div class="wrapper">
        <br><br>
    <font color="black">
      <h1>Username: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="username" minlength="3"size="30" value="<?php if (!empty($_POST['username'])) echo $_POST['username'] ; ?>"required></h1>
      <br></font><font color="black">
      <h1>User names can be any combination of letters, numbers, underscores and hyphens, up to 15 characters in length.It cant be changed later!!</h1>
      </font>
      <br><br>
      <p><br>
      <h1><font color="black">Email: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="email" name="email" size="30" value="<?php if (!empty($_POST['email'])) echo $_POST['email'] ; ?>"required></h1>

      <br><br></font>
    </p>

 <p>
      <h1><font color="black">Password: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="pass" size="30" id="ck_p1"></h1>

      <br><br></font>
    </p>

    <p>
      <h1><font color="black">Re-type Password: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="rpass" size="30"id="ck_p2"></h1>
...
<p>
 <h1><font color="black">School: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="school" size="30" value="<?php if (!empty($_POST['school'])) echo $_POST['school'] ; ?>"></h1>
 ...
 State: <select name="state" >
  ...
  <p>
 <h1><font color="black">Contact No.: &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="number" size="10" value="<?php if (!empty($_POST['number'])) echo $_POST['number'] ; ?>"></h1>
  ...
  <p>
 <h1><font color="bl">Timing(24 hr):  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><font color="black">From: <input type="text" name="t1" size="10" value="<?php if (!empty($_POST['t1'])) echo $_POST['t1'] ; ?>">  &nbsp;&nbsp;To:  <input type="text" name="t2" size="10" value="<?php if (!empty($_POST['t2'])) echo $_POST['t2'] ; ?>"></h1>
...
(g) You will not post, d…</textarea>
 ...
 <p align="center">
      <input type="submit" class="btn btn-primary" value="register" name="register" id="ck_btn"></p>
      </form>
...
function validateEmpty(fld) {
    ...
    if (fld.value.length == 0) {
        fld.style.background = 'paleYellow'; 
...
<?php 
      require_once('footer.php'); 
        ...
        {   
            ...
            if(!empty($n1)&&!empty($e1)&&!empty($p1)&&!empty($p2)&&!empty($user)&&!empty($class)&&!empty($school)&&!empty($loct)&&!empty($ct)&&!empty($nm)&&!empty($tm1)&&!empty($tm2)&&!empty($st))
            {
              if($p1===$p2)
              {
                    if(strlen($p1)>=6&&strlen($user)>=5&&preg_match('/^\d{10}$/', $nm))
                    {
                      ...
                      else
                      {
                          ...
                          $query1="insert into log(username,password,type) values ('$user','$p1','student')";
                          $query2="insert into student(username,password,name,email,class,school,Location,city,state,phone,t1,t2) values('$user','$p1','$n1','$e1','$class','$school','$loct','$ct','$st',$nm,$tm1,$tm2)";
                          mysqli_query($d1,$query1);
                     $status2=mysqli_query($d1,$query2);

                     if($status2)
                     {
                         echo "<script type='text/javascript'>alert('you have been registered!');location.href='home.php'</script>"; 
                     }
                     else
            ...
            {
                  echo "<script type='text/javascript'>alert('minimum length of password is 6 and username is 5! or phone number is invalid!!');</script>";
            }
          }
              else
              {
